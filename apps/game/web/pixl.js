const Pixl = (() => {
  ...
  const ICONS = {
    ...
    // heart, tapering to a point — matches the vote button on the page itself
    "show-n-tell": `<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><rect x="3" y="3" width="4" height="3"/><rect x="9" y="3" width="4" height="3"/><rect x="2" y="6" width="12" height="3"/><rect x="4" y="9" width="8" height="2"/><rect x="6" y="11" width="4" height="2"/><rect x="7" y="13" width="2" height="1"/></svg>`,
  };
