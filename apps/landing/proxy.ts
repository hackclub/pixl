...
export const config = {
  ...
  matcher: [
    "/((?!_next|favicon|icon|apple-icon|api|shop|orders|collectibles|play|vault|explore|ideas|quests|trials|timeline|projects|report|hackatime|refers|account|calc|docs|form|dashboard|show-n-tell|web-shell-assets|img|fonts|pixl|index|hero-bg|step-|pixel_|hc-logo|og-boot-splash|world-map|flow-|robots\\.txt|sitemap\\.xml).*)",
  ],
};
